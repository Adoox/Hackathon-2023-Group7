...
const MoneyMagic = () => {
  ...
  return (
    <div>
      ...
      <div>
        <div class="mb-4 form__group field">
          <input
            class="form__field"
        ...
        <div class="mb-5 relative h-10 w-72 min-w-[200px]">
          <select
        ...
        <div class="mb-6 relative h-10 w-72 min-w-[200px]">
          <select
          ...
          <div class="mb-5" />
          <p> Result: {result.new_amount}</p>
          <button
            type="button"
            class="text-black-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
          >
            <a href="/crypto">LEARN ABOUT CRYPTO</a>
          </button>
        </div>
      </div>
    </div>
